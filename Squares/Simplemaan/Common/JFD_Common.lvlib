...
<Library LVVersion="14008000">
	...
	<Item Name="find immediate threats.vi" Type="VI" URL="../find immediate threats.vi"/>
	<Item Name="find threat.vi" Type="VI" URL="../find threat.vi"/>
	<Item Name="geographic index Maze Input.vi" Type="VI" URL="../geographic index Maze Input.vi"/>
	<Item Name="personality.ctl" Type="VI" URL="../personality.ctl"/>
	<Item Name="random action.vi" Type="VI" URL="../random action.vi"/>
	<Item Name="random direction.vi" Type="VI" URL="../random direction.vi"/>
	<Item Name="random personality.vi" Type="VI" URL="../random personality.vi"/>
</Library>
